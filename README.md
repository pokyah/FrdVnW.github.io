...
[Click here](https://daktilo.github.io/) to see the theme in action.
...
- Font-Awesome Icons.
- Optimized for SEO.
- Coolest [404 page ever](https://electrik-frog.com/daktilo/404.html).
...
Finally execute `jekyll serve --watch` and head to [localhost:4000](https://127.0.0.1:4000) to see the result.
